...
(function($) {
    ...
    function CloudZoom(g, i) {
        ...
        setTimeout(function() {
            if (n === null) {
                var w = g.width();
                g.parent().append(format('<div style="width:%0px;position:absolute;top:75%;left:%0px;text-align:center" class="cloud-zoom-loading" >Loading...</div>', w / 3, (w / 2) - (w / 6))).find(':last').css('opacity', 0.5)
            }
        },
        200);
        var F = function() {
        ...
        this.init = function() {
            $('.cloud-zoom-loading', g.parent()).remove();
            n = g.parent().append(format("<div class='mousetrap' style='background-image:url(\".\");z-index:999;position:absolute;width:%0px;height:%1px;left:1px;top:1px;\'></div>", j.outerWidth(), j.outerHeight(), 0, 0)).find(':last');
            ...
            function(a) {
                ...
                m = e.append(format('<div id="cloud-zoom-big" class="cloud-zoom-big" style="display:none;position:absolute;left:460px;top:-6px;width:300px;height:300px;background-image:url(\'%4\');z-index:99;"></div>', b, yPos, w, h, s.src)).find(':last');

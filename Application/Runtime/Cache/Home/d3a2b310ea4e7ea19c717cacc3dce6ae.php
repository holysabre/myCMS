			...
			<aside class="inside_right clearfix">
				...
				<div class="inside_con">
					<div class="news_detail">
						...
						<div class="news_detail_time">发布时间：<?php echo (get_strtotime($info["time"])); ?> 点击数：<?php echo ($info["count"]); ?>次</div>
						<div class="news_detail_con">
							<?php echo (get_htmlcode($info["content"])); ?>
						</div>
						<div class="news_detail_prev">
							<?php if(isset($info['prev'])): ?><a href="<?php echo (get_home_url($info["prev"]["id"],$info['prev']['pid'])); ?>">上一篇：<?php echo ($info["prev"]["title"]); ?></a><?php endif; ?>
							<?php if(isset($info['next'])): ?><a href="<?php echo (get_home_url($info["next"]["id"],$info['next']['pid'])); ?>">下一篇：<?php echo ($info["next"]["title"]); ?></a><?php endif; ?>
						</div>
					</div>
				</div>
			</aside>

		...
		<form method="post" class="form form-horizontal" id="form-auth-add">
			<div class="row cl">
				...
				<div class="formControls col-10">
					<input type="text" class="input-text" value="<?php echo ($data["name"]); ?>" placeholder="角色名称" id="" name="name">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-2"><span class="c-red">*</span>角色备注：</label>
				<div class="formControls col-10">
					<input type="text" class="input-text" value="<?php echo ($data["note"]); ?>" placeholder="备注信息" id="" name="note">
				</div>
			</div>
			<div class="row cl">
			...
			<div class="row cl">
				...
				<div class="formControls col-4"> 
					<span class="check-box">
						...
						<?php if(is_array($data["menu"])): $i = 0; $__LIST__ = $data["menu"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$m): $mod = ($i % 2 );++$i;?><input type="checkbox" class="checkbox" name="auth[]" value="<?php echo ($m["id"]); ?>" data-pid="<?php echo ($m["pid"]); ?>" <?php echo $m['checked']==1?'checked':'';?>/><?php echo ($m["title_show"]); echo ($m["name"]); ?><br /><?php endforeach; endif; else: echo "" ;endif; ?>
					</span>
				</div>
			</div>
			<div class="row cl">

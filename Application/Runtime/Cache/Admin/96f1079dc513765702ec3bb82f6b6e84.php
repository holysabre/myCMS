	...
	<div class="pd-20">
		<div class="cl pd-5 bg-1 bk-gray">
			<span class="l">
					...
					<a class="btn btn-primary radius" onclick="banner_edit('新增幻灯片','<?php echo U('edit');?>','0')" href="javascript:;">
			...
			<table class="table table-border table-bordered table-bg table-hover table-sort">
				...
				<tbody>
					<?php if(is_array($data["data"])): $i = 0; $__LIST__ = $data["data"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c">
							...
							<td class="thumbnail">
								<?php if($vo["img"] != ''): ?><img src="<?php echo ($vo["img"]); ?>" width="30" height="30" />
									<div class="thumb_pic"><img src="<?php echo ($vo["img"]); ?>" width="100" height="100" /></div><?php endif; ?>
							</td>
							...
							<td class="f-14 td-manage">
								<a style="text-decoration:none" class="ml-5" onClick="banner_edit('幻灯片编辑','<?php echo U('edit');?>','<?php echo ($vo["id"]); ?>')" href="javascript:;" title="编辑">

...
<script type="text/javascript" src="/myCMS/Application/Admin/View/Static/lib/kindeditor/kindeditor-min.js"></script>
	...
	<body>
		<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 系统管理 <span class="c-gray en">&gt;</span> 站点配置 
		...
		<div class="pd-20">
			<div class="cl pd-5 bg-1 bk-gray mt-20"> 
				<span class="l">
					...
					<a class="btn btn-primary radius" onclick="article_add('添加配置','<?php echo U('settingEdit');?>')" href="javascript:;">
						<i class="Hui-iconfont">&#xe600;</i> 添加配置
					</a>
					<a class="btn btn-primary radius" onclick="reflash_cache('<?php echo U('reflash');?>','config')" href="javascript:;">
						<i class="Hui-iconfont">&#xe68f;</i> 刷新配置缓存
					</a>
				</span>				
				...
				<table class="table table-border table-bordered table-bg table-hover table-sort">
					...
					<tbody>
						<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c">
								...
								<td class="text-l"><?php echo (get_span($vo["title"],$vo['id'],'title')); ?></td>
								<td class="text-l"><?php echo (get_span($vo["note"],$vo['id'],'note')); ?></td>
								<td><?php echo ($group_list[$vo['groups']]); ?></td>
								...
								<td class="f-14 td-manage">
									<a style="text-decoration:none" class="ml-5" onClick="article_edit('编辑','<?php echo U('settingEdit');?>','<?php echo ($vo["id"]); ?>')" href="javascript:;" title="编辑">

...
<body>
	<nav class="breadcrumb">
		<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 内容管理 
	...
	<table class="table">
		<tr>
			<td width="200" class="va-t nav_left">
				<div id="left_menu" class="left_menu">
					<ul>
						<?php if(is_array($menu)): $i = 0; $__LIST__ = $menu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U($vo['url']);?>" class=" <?php echo $vo['disabled']=='1'?'amenu_disabled':'amenu';?>" > <?php echo ($vo["title_show"]); echo ($vo["name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
					</ul>
				</div>
			</td>
			<td class="nav_right va-t">
				<IFRAME ID="contentIframe" Name="contentIframe" FRAMEBORDER=0 SCROLLING=AUTO width=100%  height=90% SRC=""></IFRAME>
			</td>
		</tr>
	</table>
...
<script type="text/javascript" src="/myCMS/Application/Admin/View/Static/js/style.js"></script>
	...
	<script type="text/javascript">
		$(function(){
			...
			$('.nav_right').height(heights);
			$('#contentIframe,#left_menu').height($("#frame").height());
        	$('body').css('overflow','hidden').attr("scroll","no");
        	$('.amenu').click(function(){
        		var menu_url = $(this).attr('href');
        		$('#contentIframe').attr('src',menu_url);
        		return false;
        	})
		})
	</script>
